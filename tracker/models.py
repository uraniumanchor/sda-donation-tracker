...
class Donation(models.Model):
	...
	bidState = models.CharField(max_length=255, choices=(('PENDING', 'Pending'), ('PROCESSED', 'Processed'), ('FLAGGED', 'Flagged')))
	readState = models.CharField(max_length=255, choices=(('PENDING', 'Pending'), ('AMOUNT_READ', 'Amount Read'), ('COMMENT_READ', 'Comment Read'), ('FLAGGED', 'Flagged')))
	commentState = models.CharField(max_length=255, choices=(('PENDING', 'Pending'), ('APPROVED', 'Approved'), ('DENIED', 'Denied')))
	amount = models.DecimalField(decimal_places=2,max_digits=20)
